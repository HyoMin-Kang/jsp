...
public class ShopBookDBBean {
    ...
    throws Exception {
        ...
        try {
            ...
            String sql2 = "select * from book where book_kind between 100 and 199 order by reg_date desc";
            String sql3 = "select * from book where book_kind between 200 and 299 order by reg_date desc";
            String sql4 = "select buy.book_id, count(buy.book_id), book.book_kind, book.book_title, book.book_price, book.book_count, book.author, book.publishing_com, book.publishing_date, book.book_image, book.discount_rate, book.reg_date from buy left outer join book on buy.book_id = book.book_id group by(buy.book_id) order by count(buy.book_id) desc limit 0, 10";
            String sql5 = "select * from book where book_kind = ? order by reg_date desc";
