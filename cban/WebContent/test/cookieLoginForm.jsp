...
<body class="text-center">
	...
	<form name="loginForm" class="form-signin" method="post" action="cookieLoginPro.jsp">
			...
			<div class="form-check form-check-inline">
				<input class="form-check-input" type="checkbox" name="saveId" id="loginCheck1"<% if(id.isEmpty()==false) out.print(" checked=\"checked\"");%>>
				<label class="form-check-label" for="loginCheck1">아이디 저장</label>
			</div>
			<div class="form-check form-check-inline">
				<input class="form-check-input" type="checkbox" name="autoLogin" id="loginChech2">
				<label class="form-check-label" for="loginChech2">자동 로그인</label>
			</div>
			
			<button type="submit" class="btn btn-lg btn-outline-dark btn-block">log in</button>
			<a href="insertMemberForm.jsp" target="_blank"><i class="fas fa-external-link-alt fa-sm"> 회원 가입하기</i></a>
