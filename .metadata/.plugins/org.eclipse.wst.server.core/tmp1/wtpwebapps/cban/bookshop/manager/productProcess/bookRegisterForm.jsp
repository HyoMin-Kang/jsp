		...
		<div class="form-group row">
			...
			<div class="col-sm-4">
	    		<select class="form-control" id="book_kind" name="book_kind">
	    			<optgroup label="국내도서">
						<option value="100">건강 취미</option>
						<option value="110">경제 경영</option>
						<option value="120">문학</option>
						<option value="130">사회 정치</option>
						<option value="140">자기계발</option>
						<option value="150">자연과학</option>
						<option value="160">참고서</option>
					</optgroup>
	    			<optgroup label="외국도서">
						<option value="200">문학 소설</option>
						<option value="210">경제 경영</option>
						<option value="220">인문 사회</option>
						<option value="230">예술 대중문화</option>
						<option value="240">취미 라이프스타일</option>
						<option value="250">컴퓨터</option>
						<option value="260">자연과학</option>
					</optgroup>
	    		</select>
	  		</div>
		</div>
